...
export const getCondition = (func: codeboolexpr) => Condition(getHandledThread(func))

export const getFilter = (func: codeboolexpr) => Filter(getHandledThread(func))
...
export const enumDestructablesInRect = (r: rect, filterFunc: codeboolexpr, actionFunc: code) =>
    EnumDestructablesInRect(r, getFilter(filterFunc), getHandledThread(actionFunc))

export const enumItemsInRect = (r: rect, filterFunc: codeboolexpr, actionFunc: code) =>
