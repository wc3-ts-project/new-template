...
ceres.runConfig = {
    ...
    mapDataDir = "C:\\Users\\WriteCoin\\Documents\\Warcraft III Public Test\\CustomMapData", -- points Ceres to the CustomMapData folder for interop with the WC3 client. optional.
